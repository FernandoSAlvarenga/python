    ...
    def abrir_topico(self, topico):
        ...
        if topico=="Widgets: Blocos de Construção":
            ...
            def Label_explicacao():
                ...
                conteudo_label = tk.Label(nova_janela, text="Labels: Exibem texto na tela.",font=("Arial", 20, "bold"))
                conteudo_label.pack()
            ...
            def Entries_explicacao():
                ...
                def exemplo_entry():
                    ...
                    label = tk.Label(janela, text="Digite seu nome:") #label é o responsável pela escrita da tela
                    label.pack()

                    entry = tk.Entry(janela) #recebe
                    entry.pack()
